...
export const ITEM_CONFIG = {
    ...
    IDOL_CHAIN_FIRST_INDEX: 0,
    IDOL_CHAIN_SECOND_INDEX: 1,
    IDOL_CHAIN_FIRST_DEPENDENT_INDEX: 2,
    IDOL_CHAIN_LIMIT: 30,
    IDOL_CHAIN_PREVIOUS_OFFSET: 1,
    IDOL_CHAIN_VISIBLE_AFTER_OFFSET: 2,
    IDOL_CHAIN_INTERVAL_MULTIPLIER: 0.00000000000001,
};
